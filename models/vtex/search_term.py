...
class SearchTermModel(BaseModel):
    ...
    search_name: str = Field(example="azeite")
    ...
    image: str = Field(example="https://www.mambo.com.br/arquivos/ids/157385/"
                               "acucar-refinado-uniao-1kg.jpg?v=637883104663670000")
    created_at: datetime.date = Field(example="2023-05-01")
    hour: datetime.time = Field(example="10:00:00")


class SearchTermHeader(PaginationModel):
    """ Class SearchTermHeader """
    data: List[SearchTermModel]
